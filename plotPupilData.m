function plotPupilData (matfile,pupilflag)

if ~exist('pupilflag', 'var')
    pupilflag = true;
end
...
if pupilflag %discard samples where the PupilTracked flag is false
    figure
...
else % include all samples regadless of the Tracking Flag
    figure
