...
dateIDs = {'060816' '060716' '060116' '053116' '060616' '060216' '062816' '061016'}
...
acquisitionFreqs = [60 60 30 30 60 30 60 60];
NRunss = [9 9 9 9 9 9 9 4];
...
for ss = 1:NSubjects
    ...
    acquisitionFreq = acquisitionFreqs(ss);
    NRuns = NRunss(ss);
    ...
    for ii = 1:NContrastLevels
        ...
        Data_Per_ContrastLevel_xrun_SEM{ii} = std(Data_Per_ContrastLevel_Mean{ii}, [], 2)/sqrt(NRuns);
    ...
    csvwrite(fullfile(outPath, [subjectID '-' protocol '-' dateID '_CRF.csv']), Data_Per_ContrastLevel_xrun_MeanMin');
end