...
pupilData = {'MELA_analysis/MelanopsinMRMaxLMSCRF/HERO_asb1/HERO_asb1-MelanopsinMRMaxLMSCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxLMSCRF/HERO_aso1/HERO_aso1-MelanopsinMRMaxLMSCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxLMSCRF/HERO_gka1/HERO_gka1-MelanopsinMRMaxLMSCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxLMSCRF/HERO_mxs1/HERO_mxs1-MelanopsinMRMaxLMSCRF_TimeSeries.csv', ...
    'MELA_analysis/MelanopsinMRMaxMelCRF/HERO_asb1/HERO_asb1-MelanopsinMRMaxMelCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxMelCRF/HERO_aso1/HERO_aso1-MelanopsinMRMaxMelCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxMelCRF/HERO_gka1/HERO_gka1-MelanopsinMRMaxMelCRF_TimeSeries.csv' ...
    'MELA_analysis/MelanopsinMRMaxMelCRF/HERO_mxs1/HERO_mxs1-MelanopsinMRMaxMelCRF_TimeSeries.csv'};

for ss = 1:NDatasets
    CRF_LMS(:, ss) = csvread(fullfile(localDropboxDir, pupilData{ss}));
end
